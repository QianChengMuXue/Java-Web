    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <form class="form-signin" action="reg-submit.jsp" method="post">
                <h2 class="form-signin-heading">注册学工系统</h2>
                <div id="info">

                </div>
                <label for="">学号：</label>
                <input type="text" name="name" id="name" class="form-control" placeholder="请输入学号" required autofocus><br>
                <label for="">姓名：</label>
                <input type="text" name="username" id="username" class="form-control" placeholder="请输入姓名" required autofocus></br>
                <label for="">密码：</label>
